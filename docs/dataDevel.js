...
var waza_list = [
  ...
  {	name: 'バーキャッチ',
	seq: [['バーキャッチ']] },
  {	name: 'バーキャッチ(左のみ)', // もし、両手とも握ってたら、むしろ右手離手の動きになる
	seq: [['バーキャッチ', { grip: ['catch', 'release']}]] },
  {	name: 'バーキャッチ(右のみ)', // もし、両手とも握ってたら、むしろ左手離手の動きになる
	seq: [['バーキャッチ', { grip: ['release', 'catch']}]] },
  {	name: '抱え込み(弱)',
	seq: [['抱え込み(弱)']] },
  {	name: '抱え込み(強)',
	seq: [['抱え込み(強)']] },
  ...
  {	name: '屈身(強)',
	seq: [['屈身(強)']] },
  {	name: 'アドラー',
	seq: [['押し', // アドラーは、部品名全部「押し」でバリエーションで全指定している。
