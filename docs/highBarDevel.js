  ...
  { name: '翻転',
	seq: [
	  { shoulder: [[140, 0.55], [140, 0.55]],
		hip: [[-15, 0, 0, 0.6, 0.2, 0.2], [-15, 0, 0, 0.6, 0.2, 0.2]],
		chest_head: [0, 0, 0],
		spine_chest: [0, 0, 10],
		pelvis_spine: [0, 0, -15],
		knee: [[0, 0.1], [0, 0.1]],
	  ...
	  { shoulder: [[130, 0.05], [130, 0.05]],
		hip: [[20, 0, 0, 0.22, 0.2, 0.2], [20, 0, 0, 0.22, 0.2, 0.2]],
		chest_head: [0, 0, 0],
		spine_chest: [0, 0, 25],
		pelvis_spine: [0, 0, 25],
		knee: [[0, 0.1], [0, 0.1]],
  ...
  {	name: 'シュタルダー',
	seq: [
	  { shoulder: [[85, 0.4], [85, 0.4]],
		hip: [[-10, 0, 0, 0.6, 0.2, 0.2], [-10, 0, 0, 0.6, 0.2, 0.2]],
		chest_head: [0, 0, 0],
		spine_chest: [0, 0, 15],
		pelvis_spine: [0, 0, -15],
		knee: [[0, 0.1], [0, 0.1]],
	  ...
	  { shoulder: [[40, 0.15], [40, 0.15]],
		hip: [[145, -35, 0, 0.1, 0.1, 0.2], [145, 35, 0, 0.1, 0.1, 0.2]],
		chest_head: [0, 0, 5],
		spine_chest: [0, 0, 25],
		pelvis_spine: [0, 0, 30],
		knee: [[0, 0.1], [0, 0.1]],
	  ...
	  { shoulder: [[35, 0.15], [35, 0.15]],
		hip: [[0, 0, 0, 0.3, 0.3, 0.2], [0, 0, 0, 0.3, 0.3, 0.2]],
		chest_head: [0, 0, 10],
		spine_chest: [0, 0, 5],
		pelvis_spine: [0, 0, 5],
		knee: [[0, 0.1], [0, 0.1]],
	  ...
	  { shoulder: [[5, 0.25], [5, 0.25]],
		hip: [[4, 0, 0, 0.35, 0.35, 0.2], [4, 0, 0, 0.35, 0.35, 0.2]],
		chest_head: [0, 0, 3],
		spine_chest: [0, 0, 2],
		pelvis_spine: [0, 0, 2],
		knee: [[0, 0.1], [0, 0.1]],
